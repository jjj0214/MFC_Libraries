...
// CExcelPictures wrapper class

class CExcelPictures : public COleDispatchDriver
{
public:
	CExcelPictures(){} // Calls COleDispatchDriver default constructor
	CExcelPictures(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcelPictures(const CExcelPictures& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
