...
// CExcelWorksheet wrapper class

class CExcelWorksheet : public COleDispatchDriver
{
public:
	CExcelWorksheet(){} // Calls COleDispatchDriver default constructor
	CExcelWorksheet(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcelWorksheet(const CExcelWorksheet& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
