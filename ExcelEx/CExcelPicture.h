...
// CExcelPicture wrapper class

class CExcelPicture : public COleDispatchDriver
{
public:
	CExcelPicture(){} // Calls COleDispatchDriver default constructor
	CExcelPicture(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcelPicture(const CExcelPicture& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
